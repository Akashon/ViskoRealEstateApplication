...
// //       final url = 'https://apimanager.viskorealestate.com/fetch-Testing-filters'
// //           '?subcategory=$apiSubc'
// //           '&location=$location'
// //           '&type=$apiType'
// //           '&sq_ft=$sqFt';
...
// // START THIS HERO HOME PAGE MAIN
...
// // /// Full Testing with redesigned Developer Cards (Style A)
// // class Testing extends StatefulWidget {
// //   const Testing({super.key});
...
// // /// Full Testing with redesigned Developer Cards (Component-based)
// // class Testing extends StatefulWidget {
// //   const Testing({super.key});
...
//   //   try {
//   //     final url =
//   //         'https://apimanager.viskorealestate.com/fetch-Testing-filters?subcategory=$subc&location=$location&type=$type&sq_ft=$sqFt';
//   //     final response = await http.get(Uri.parse(url));
//   //     final data = jsonDecode(response.body);
...
class _BottomNavBarPageState extends State<BottomNavBarPage> {
  ...
  void initState() {
    ...
    /// 🔥 Delay required so context is ready
  ...
  /// ---------------- CHECK PERSONAL INFO ----------------
  void _checkPersonalInfo() {
    /// 👉 Replace this with real logic (API / local storage)
    final bool isProfileIncomplete = true; // example
        ...
        bottomNavigationBar: Container(
          decoration: BoxDecoration(
            gradient: isDark
                ? LinearGradient(
                    colors: [
                      glass.solidSurface.withOpacity(0.85),
                      glass.solidSurface.withOpacity(0.65),
                    ],
                    begin: Alignment.topCenter,
                    end: Alignment.bottomCenter,
                  )
          ...
          child: CurvedNavigationBar(
            ...
            buttonBackgroundColor: glass.chipSelectedGradientStart,
  ...
  Widget _buildIcon({
    ...
    return Icon(
      ...
      size: 30,
      color: selected
          ? glass.solidSurface // ✅ NOT Colors.white
          : glass.textSecondary,
    );
  }
}
