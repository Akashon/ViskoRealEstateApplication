...
class PropertyAdvisorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: CupertinoNavigationBarBackButton(
          color: glass.textPrimary, // 🔥 UPDATED (theme based)
          onPressed: () => Get.back(),
        ),
        title: Text(
          "Property Advisor",
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          padding: const EdgeInsets.all(20),
          decoration: BoxDecoration(
            color: glass.glassBackground, // 🔥 UPDATED
            borderRadius: BorderRadius.circular(30),
            border: Border.all(color: glass.glassBorder), // 🔥 UPDATED
          ),
          child: Row(
            children: [
              CircleAvatar(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: [
                        ...
                        glass.chipSelectedGradientEnd, // 🔥 UPDATED
                      ],
                    ),
                  ),
                  child: Icon(
                    icon,
                    color: glass.solidSurface, // 🔥 UPDATED (NO Colors.white)
                  ),
                ),
                const SizedBox(width: 15),
                Expanded(
